    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rom', models.CharField(default='64gb', max_length=255, verbose_name='Количество всторенной памяти')),
                ...
                ('sd_value_max', models.CharField(blank=True, max_length=255, null=True, verbose_name='Максимально количество доп. памяти')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hard_disk', models.CharField(choices=[('SSD', 'ssd'), ('HDD', 'hdd'), ('NVM', 'nvm')], default='SSD', max_length=3)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.category', verbose_name='Категория')),
            ],
            options={
                'abstract': False,
